...
$(TARGET_PREBUILT_INT_KERNEL_IMAGE): $(KERNEL_OUT) $(KERNEL_HEADERS_INSTALL)
	...
	$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) $(KERNEL_CFLAGS) Image
